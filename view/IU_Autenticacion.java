...
public class IU_Autenticacion extends JFrame {
    public static void main(String[] args) {
        ...
        panel.setBackground(Color.decode("#D8BFD8")); 
        frame.add(panel);
    ...
    private static void placeComponents(JPanel panel) {
        ...
        nameLabel.setForeground(Color.decode("#ADD8E6")); 
        ...
        surnameLabel.setForeground(Color.decode("#ADD8E6")); 
        ...
        emailLabel.setForeground(Color.decode("#ADD8E6")); 
        ...
        passwordLabel.setForeground(Color.decode("#ADD8E6")); 
        ...
        birthdateLabel.setForeground(Color.decode("#ADD8E6")); 
